...
//        MailUtils.sendTestMail(email, code);
        ...
        simpleMailMessage.setFrom(new InternetAddress(MimeUtility.encodeText("LuckyOJ")+"															<749384114@qq.com>").toString());
        try {
